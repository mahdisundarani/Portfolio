...
import HaptikAI from './assets/work_logo/HaptikAI.png';
...
export const experiences = [
  {
    ...
    desc: "Worked as a Research Intern at Indian Institute of Technology Hyderabad, where I contributed to agentic AI and infrastructure automation research by building an end-to-end LLM/SLM evaluation pipeline for Terraform-based VM provisioning on XCP-ng. I benchmarked models including Qwen, DeepSeek, and Codex across CRUD infrastructure tasks, developed validated ground-truth datasets from LLM-generated IaC code, and automated evaluation workflows using semantic scoring techniques such as BLEU, BERTScore, and LLM-as-a-judge. I also contributed to a multi-agent infrastructure automation system integrating Terraform and OPA for safe, scalable, and verification-driven IaC execution.",
    skills: [
      "Machine Learning",
      "Deep Learning",
      "Python",
  ...
  // },
  {
    ...
    desc: "Completed DeepLearning.AI’s Machine Learning and NLP Specializations in collaboration with Stanford University, building regression, classification, clustering, and neural network models using Scikit-learn, TensorFlow, and Keras. Developed ML and NLP projects including placement prediction systems, Iris classification, and Fashion MNIST applications, while designing LLM-powered solutions with Hugging Face and LangChain. Gained hands-on experience implementing ANN, RNN, LSTM, GRU, and Transformer architectures, and applied them to create agentic AI workflows with retrieval, reasoning, and tool-calling capabilities. Also developed an AI-powered campus assistant using RAG, LangGraph multi-agent orchestration, and MCP-based tool integration to deliver structured, citation-backed responses.",
    skills: [
      "Python",
      "NumPy",
      "Pandas",
...
export const projects = [
  {
    ...
    ,
    github: "https://github.com/mahdisundarani/yelp-camp.git",
  ...
  },
  {
    ...
    ,
    github: "https://github.com/mahdisundarani/iNotebook.git",
